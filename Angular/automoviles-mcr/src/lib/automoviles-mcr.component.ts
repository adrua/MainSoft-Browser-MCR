...
<div>   
    <mcrco-automoviles-table></mcrco-automoviles-table>
</div>
  `,
  styles: [`
.mat-table {
...
export class AutomovilesMcrComponent  {
  show = false;
  ...
  language = 'es-mcrco-automoviles-638439362955454146';

  constructor(readonly translate: TranslateService) { 
        console.log('Automovilesmcr - mcrco-automoviles');
